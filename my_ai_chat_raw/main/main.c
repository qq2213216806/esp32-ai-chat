...
void app_main(void)
{
	...
	// 文字转语音 初始化
    Volcengine_tts_config_t tts_config = {
        .playback_sample_rate = 16000,
    };
    Volcengine_tts_handle_t tts = Volcengine_tts_init(&tts_config);
	...
	Volcengine_tts_set_listener(tts, evt);
    ...
    while (1)
    {
        ...
        } else if (msg.cmd == PERIPH_BUTTON_RELEASE || msg.cmd == PERIPH_BUTTON_LONG_RELEASE)
		{
			...
			Volcengine_tts_start(tts,"小灰毛,你好");
        }
